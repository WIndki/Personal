...
void print() 打印线性表
*/
// void MergeList(LinearList<T> &L1,LinearList<T> &L2,LinearList<T>
// &L3);//合并两个有序线性表
...
void MergeList(LinearList<int> &L1, LinearList<int> &L2,
               LinearList<int> &L3) { // 合并两个有序线性表
  int i = 0, j = 0;
  while (i < L1.getLength() && j < L2.getLength()) {
    if (L1.get(i) <= L2.get(j)) {
      L3.push_back(L1.get(i++));
    } else {
